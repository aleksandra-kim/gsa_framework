...
#
#         # y1 = problem.run_locally()
#         # print(y1[:10])
#         y2 = problem.run_remotely()
#         print(y2[:10])
#
#         # Plotting
...
from gsa_framework import RunModelParallel
import numpy as np

if __name__ == "__main__":
    iterations = 50
    X = np.random.rand(iterations, 20)
    run = RunModelParallel(iterations=iterations)
    res = run.calculate()
    print(res)
