...
def sobol_indices(filepath_Y, num_params, selected_iterations=None):
    ...
    filepath_Y : Path or str
        Filepath to model outputs ``y`` in .hdf5 format obtained by running model according to Saltelli samples.
    num_params : int
        Number of model inputs.
    selected_iterations : array of ints
        Iterations that should be included to compute Sobol indices.
